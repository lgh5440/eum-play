...
export const RELAY_THEMES = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg,#FFD98C,#b45309)', accent: '#FFD98C',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg,#2563EB,#4338ca)', accent: '#93C5FD',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg,#9C6F0F,#9C6F0F)', accent: '#9C6F0F',
