...
export const RELAY_THEMES = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg,#4338CA,#6366F1)', accent: '#C7D2FE',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(135deg,#9C6F0F,#7f1d1d)', accent: '#9C6F0F',
