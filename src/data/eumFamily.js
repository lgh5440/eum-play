...
export const EUM_FAMILY = [
  ...
  { key: 'myrealid', name: '이음 캠프', tagline: '수련회·모임 운영 도우미', emoji: '🏕️', url: 'https://eum-camp-template.web.app/', accent: '#93C5FD' },
  { key: 'eumplay', name: '이음 플레이', tagline: '교회 활동 게임 9종 · 진행 도우미', emoji: '🎲', url: 'https://lgh5440.github.io/eum-play/', accent: '#3B82F6' },
  { key: 'eumschool', name: '이음 스쿨', tagline: '교회학교 통합 양육', emoji: '📚', url: 'https://lgh5440.github.io/eum-school-v5-demo/', accent: '#2563EB' },
