      ...
      <div className="max-w-md w-full text-center">
        ...
        {error && (
          <details className="text-left mb-5 rounded-xl px-3 py-2 cursor-pointer"
            ...
            <summary className="font-bold" style={{ color:'#9C6F0F', fontSize: 11, letterSpacing: '0.08em' }}>
              ▸ 에러 정보 (개발자용)
            </summary>
        ...
        <div className="flex gap-2">
          <button onClick={reset}
            ...
            style={{ background:'rgba(99,102,241,0.2)', color:'#93C5FD', border:'1px solid rgba(99,102,241,0.35)' }}>
            🔄 다시 시도
          </button>
